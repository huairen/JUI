...
enum ControlClass
{
	...
	CTRL_CLASS_HORIZLAYOUT	= (0x0010 | CTRL_CLASS_CONTAINER),
	CTRL_CLASS_CHECK_BUTTON	= (0x0020 | CTRL_CLASS_BUTTON),
	CTRL_CLASS_RADIO_BUTTON	= (0x0040 | CTRL_CLASS_CHECK_BUTTON),
};
